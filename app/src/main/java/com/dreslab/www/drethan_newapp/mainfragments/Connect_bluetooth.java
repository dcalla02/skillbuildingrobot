...
import com.dreslab.www.drethan_newapp.subFragments.bluetooth.bluetoothClient_fragment;
import com.dreslab.www.drethan_newapp.subFragments.bluetooth.bluetoothController_fragment;

import java.util.List;
import java.util.Vector;

public class Connect_bluetooth extends Fragment implements
    ...
    private void intTabHost(Bundle savedInstanceState){
        ...
        String[] tabName = {"Client Interface","Controller Interface"};
    ...
    private void intViewPage(){
        ...
        ListFragment.add(new bluetoothClient_fragment());
        ListFragment.add(new bluetoothController_fragment());
